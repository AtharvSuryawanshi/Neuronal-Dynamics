...
I_step = neuron.create_step_current(t, 0.1, 10, 0, 0)
I_ramp = neuron.create_ramp_current(t, 1, 10, 0, 0)
pulse_times = [0, 5, 10, 15, 20, 25, 30]  
I_pulse = neuron.create_pulse_train(t, pulse_times, 3, 0, 50)
I_ext = I_step
# a = neuron.simulate(T, dt, [-70, 0], I_ext)    
a = neuron.simulate_with_perturbations(T, dt, [-67, 0], I_ext, perturbations=[(2, 5, 0.0),
                                                                              (8, 12, 0)]) 
